...
function Footer(){
  return <footer class="site-footer">
    ...
    <div class="footer-bottom"><p>© 2026 مؤسسة الدكتور عمر هشام الخيرية</p><p>صُنع بالرحمة، ليبقى الأثر <i class="fa-solid fa-heart"></i></p></div>
  </footer>
}
...
function Layout({children,title='مؤسسة الدكتور عمر هشام الخيرية',description='عطاء مستمر لتنمية الإنسان والمجتمع'}:{children:any,title?:string,description?:string}){
  return <html lang="ar" dir="rtl"><head>
    ...
    <meta name="description" content={description}/><meta name="theme-color" content="#062d28"/>
    ...
    <div class="toast" id="toast" role="status"><i class="fa-solid fa-circle-check"></i><span></span></div>
