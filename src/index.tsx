...
function Footer(){
  return <footer class="site-footer">
    ...
    <section class="footer-main">
      ...
      <article class="newsletter"><p class="eyebrow">رسالة أثر</p><h3>خيرٌ صغير في بريدك،<br/>كل شهر.</h3><form class="ajax-form" data-endpoint="/api/newsletter"><label class="sr-only" for="newsletter-email">البريد الإلكتروني</label><div class="input-action"><input id="newsletter-email" name="email" type="email" placeholder="بريدك الإلكتروني" required/><button aria-label="اشتراك">{icon('fa-arrow-left')}</button></div></form><div class="socials"><a href="https://facebook.com" aria-label="فيسبوك"><i class="fa-brands fa-facebook-f"></i></a><a href="https://instagram.com" aria-label="إنستجرام"><i class="fa-brands fa-instagram"></i></a><a href="https://wa.me/201060920249" aria-label="واتساب"><i class="fa-brands fa-whatsapp"></i></a><a href="https://x.com" aria-label="إكس"><i class="fa-brands fa-x-twitter"></i></a></div></article>
    </section>
    <div class="footer-bottom"><p>© 2026 مؤسسة الدكتور عمر هشام الخيرية</p><div class="footer-signature"><p>صُنع بالرحمة، ليبقى الأثر <i class="fa-solid fa-heart"></i></p><a href="https://peso-is-here.vercel.app" target="_blank" rel="noopener noreferrer" aria-label="Visit PESO website"><span>Developed by</span><strong>PESO</strong><i class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></i></a></div></div>
  </footer>
}
...
function About(){return <Layout title="من نحن | مؤسسة الدكتور عمر هشام"><PageHero kicker="من نحن" title={'من الفقد وُلد نورٌ،<br/><em>ومن الحلم وُلد أثر.</em>'} text="حكاية إنسان لم يتوقف حلمه برحيله، بل صار بابًا للخير يدخل منه الجميع."/><section class="about-memorial section-pad"><div class="memorial-image reveal"><img src="/static/omar-portrait.jpg" alt="الدكتور عمر هشام"/><div class="image-prayer">رحمه الله رحمةً واسعة</div></div><article class="memorial-text reveal"><p class="eyebrow"><span></span>صدقة جارية</p><h2>كان عمر يحلمُ بالشفاء،<br/>فنحن نُكمل الحلم.</h2><p>في ذاكرة كل من عرفه، بقي الدكتور عمر هشام شابًا طموحًا، بشوشًا، يحمل حلم الطب ورسالة الرحمة. وحين اختاره الله، قرر والده المهندس هشام صبري أن يتحوّل الحزن إلى يدٍ تمتد لكل محتاج.</p><blockquote>«ليحمل اسمُه رسالة نشر الخير والرحمة والإحسان بين الناس.»</blockquote></article></section><section class="sacred-section"><div class="sacred-pattern"></div><p class="eyebrow">دعاءٌ يصل إلى السماء</p><h2>اللهم اغفر له وارحمه، وعافه واعف عنه،<br/>وأكرم نزله، ووسّع مدخله.</h2><div class="fatiha"><h3>الفاتحة</h3><p>بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ<br/>الْحَمْدُ لِلَّهِ رَبِّ الْعَالَمِينَ ۝ الرَّحْمَنِ الرَّحِيمِ ۝ مَالِكِ يَوْمِ الدِّينِ ۝ إِيَّاكَ نَعْبُدُ وَإِيَّاكَ نَسْتَعِينُ ۝ اهْدِنَا الصِّرَاطَ الْمُسْتَقِيمَ ۝ صِرَاطَ الَّذِينَ أَنْعَمْتَ عَلَيْهِمْ غَيْرِ الْمَغْضُوبِ عَلَيْهِمْ وَلَا الضَّالِّينَ</p></div><button class="light-btn toast-trigger" data-message="جزاك الله خيرًا، تقبّل الله دعاءك ورحم حبيبنا وأسكنه فسيح جناته">قرأتُ الفاتحة وأهديتُه الرحمة {icon('fa-heart')}</button></section><section class="values section-pad"><SectionHead kicker="ما نؤمن به" title={'قيمٌ لا نكتبها على الجدران،<br/><em>بل نمارسها كل يوم.</em>'}/><div class="value-grid">{[['الإخلاص','كل ما نقدمه خالصًا لوجه الله.'],['الشفافية','وضوحٌ وأمانة في كل خطوة.'],['المسؤولية','أثر حقيقي ومستدام في المجتمع.'],['الرحمة','نقف بجوار المحتاج بلطف وكرامة.'],['الشراكة','معًا يصبح أثر الخير أكبر.']].map((v,i)=><article class="value-card reveal"><span>0{i+1}</span><h3>{v[0]}</h3><p>{v[1]}</p></article>)}</div></section></Layout>}
